...
if __name__=="__main__":
    ...
    angry_boys = AngryBoys(size = 80, remain_proba = 0.1, init_state = "all down")
#    angry_boys = RadiatingBoys(size = 30, remain_proba = 0.1, nearest_neighbour_proba = 0.4, second_neighbour_proba = 0.5, init_state = "all down")
#    angry_boys = ExponentialBoys(size = 200, J = 0.5, K = 0.5, init_state = "all down")
#    angry_boys = ProjectionBoys(size = 40, p0 = 1.0, p1 = 2.0, q1 = 2.0, q2 = 2.0, init_state = "all down")
...
#    mpb2a=[j for j in mpb]
    ...
    with open("Data/Angry_MPS_t200_s80_bd10to20.csv", "wb") as f:
        writer = csv.writer(f)
...
#    pylab.plot(range(len(mva)), mva, "-o", label = "mps, variance")
    ...
    pylab.savefig('Figs/Angry_MPS_t200_s100_bd10to20.eps')
    pylab.show()
