...
#    angry_boys = ExponentialBoys(size = 200, J = 0.5, K = 0.5, init_state = "all down")
    angry_boys = ProjectionBoys(size = 150, p0 = 1.0, p1 = 2.0, q1 = 2.0, q2 = 2.0, init_state = "all down")
...
#    mpb2a=[j for j in mpb]
    ...
    with open("Data/Projection_MPS_t200_s150_bd10to20_log.csv", "wb") as f:
        writer = csv.writer(f)
...
#    pylab.plot(range(len(mva)), mva, "-o", label = "mps, variance")
    ...
    pylab.savefig('Figs/Projection_MPS_t500_s150_bd10to20_log.eps')
    pylab.show()
