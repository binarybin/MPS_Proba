...
\item  The \texttt{Exact} class calculates the exact time evolution of the initial state for smaller sizes. It outputs results similar to those in \texttt{Measurement} in order for the comparison between two methods. Headed by Peter Gjeltema.
\end{itemize}
